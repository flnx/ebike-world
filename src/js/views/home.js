            ...
            <div class="ar-flex-wrap mb">
                ...
                <aside class="flex__2">
                    ...
                    <section class="box bs">
                        <h4>
                            How to imrpove your stamina and why cycling is one
                            of the best ways
                        </h4>
...
const bikeIntroTemplate = (bike) => html`
    <div class="product-1">
        <a href="/bike-details/${bike.objectId}">
            <div class="bike__img">
                <img src=${bike.posterUrls.imgName1} alt="ebike image" />
            </div>
        </a>
...
const showCaseTemplate = () => html`
    <section class="showcase">
        <section class="showcase__intro">
            <h1>
                The Ultimate <span>e-Bike</span> portal of 2022 that covers all
                of your needs
            </h1>
            <p>
                We love what we do and we'd love to share it with the world.
                <br />
                Check out <span><a href="/blog">our blog</a></span> if you're
                interested in learning and exploring a whole new world of
                eBiking!
            </p>
                ...
                <section class="article__wrap">
                    ...
                    <footer>
                        <div class="ar__footer">
                            <span>
                                <time
                                    >${article.createdAt.substring(0, 10)}</time
                                >
